class Scene6 extends Phaser.Scene {
    ...
    create() {
        ...
        for (let i = -1; i < 4; i++) {
            stuck = platforms.create(1250, -20 - (i*300), 'trunk').setScale(2).refreshBody().setDepth(0.5);
            ...
            if (i > 2) {stuck.body.checkCollision.down = false; stuck.body.checkCollision.up = true;}
        }
